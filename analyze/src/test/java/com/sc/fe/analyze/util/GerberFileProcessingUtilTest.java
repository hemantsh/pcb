...
public class GerberFileProcessingUtilTest {
    ...
    public void testProcessTA1()
    {
        ...
        Assert.assertEquals(null, check.get(null));            
    }
    @Test
    ...
    public void testProcessTA3()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processTFTATO(line, "%TA");
        Assert.assertEquals("ComponentPad", check.get("AperFunction"));            
    }
    @Test
    public void testProcessTA4()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processTFTATO(line, "%TA");
        Assert.assertEquals("",check.get("AperFunctionComponentPad"));            
    }
    @Test
    ...
    public void testProcessTA8()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processTFTATO(line, "%TA");
        Assert.assertEquals("XZ12ADF,B,,Code128,,Project identifier ", check.get("FlashText"));            
    }
    ...
    public void testProcessTF1()
    {
        ...
        Assert.assertEquals(null, check.get(""));            
    }
    @Test
    ...
    public void testProcessTF3()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processTFTATO(line, "%TF");
        Assert.assertEquals("", check.get("FilePolarityPositive"));            
    }
    @Test
    ...
    public void testProcessTF5()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processTFTATO(line, "%TF");
        Assert.assertEquals("Copper,L1,Top", check.get("FileFunction"));            
    }
     @Test    
    public void testProcessTF6()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processTFTATO(line, "%TF");
        Assert.assertEquals("Positive", check.get("FilePolarity"));            
    }
    @Test
    ...
    public void testProcessTF8()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processTFTATO(line, "%TF");
        Assert.assertEquals("2016-04-25T00:00:00+01:00", check.get("CreationDate"));            
    }
    ...
    public void testProcessTO3()
    {
        String line="%TOC,R6*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processTFTATO(line, "%TO");
        Assert.assertEquals("R6", check.get("C"));            
    }
    @Test
    public void testProcessTO4()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processTFTATO(line, "%TO");
        Assert.assertEquals("R5,1", check.get("P"));            
    }
    @Test
    ...
    public void testProcessTO7()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processTFTATO(line, "%TO");
        Assert.assertEquals("N/C", check.get("N"));            
    }
    ...
    public void testProcessGO43()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processG04(line);
        Assert.assertEquals("4", check.get("Layer_Physical_Order"));   
        Assert.assertEquals("4", check.get("Layer"));
    }
    @Test
    public void testProcessGO44()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processG04(line);
        Assert.assertEquals("16711680", check.get("Layer_Color"));   
    }
    @Test
    public void testProcessGO45()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processG04(line);
        Assert.assertEquals("66mil", check.get("D50.XSize"));   
        Assert.assertEquals("66mil", check.get("D50.YSize"));   
        Assert.assertEquals("0mil", check.get("D50.CornerRadius"));   
        Assert.assertEquals("0mil", check.get("D50.HoleSize"));   
        Assert.assertEquals("FLASHONLY", check.get("D50.Usage"));   
        Assert.assertEquals("0.000", check.get("D50.Rotation"));   
   }
    ...
    public void testProcessFSLA3()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processFSLA(line);
        Assert.assertEquals("25", check.get("X"));            
        Assert.assertEquals("25", check.get("Y"));            
    }
    @Test
    public void testProcessFSLA4()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processFSLA(line);
        Assert.assertEquals("2.6", check.get("X"));            
        Assert.assertEquals("2.6", check.get("Y"));            
    }    
    ...
    public void testProcessTD3()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processTD(line);
        Assert.assertEquals("", check.get("AperFunction"));            
    }
    @Test
    public void testProcessTD4()
    {
        ...
        HashMap<String,String> check=GerberFileProcessingUtil.processTD(line);
        Assert.assertEquals("", check.get("IAmATA"));            
    }
    @Test
    ...
    public void testProcessMO3()
    {
        String line="%MOIN*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processMOLPLM(line, "MO");
        Assert.assertEquals("IN", check.get("MO"));    
    }
    @Test
    public void testProcessMO4()
    {
        String line="%MOMM*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processMOLPLM(line, "MO");
        Assert.assertEquals("MM", check.get("MO"));    
    }
    ...
    public void testProcessLP3()
    {
        String line="%LPD*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processMOLPLM(line, "LP");
        Assert.assertEquals("D", check.get("LP"));            
    }
    @Test
    public void testProcessLP4()
    {
        String line="%LPC*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processMOLPLM(line, "LP");
        Assert.assertEquals("C", check.get("LP"));            
    } 
    ...
    public void testProcessLM3()
    {
        String line="%LMX*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processMOLPLM(line, "LM");
        Assert.assertEquals("X", check.get("LM"));            
    }
    @Test
    public void testProcessLM4()
    {
        String line="%LMN*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processMOLPLM(line, "LM");
        Assert.assertEquals("N", check.get("LM"));            
    }
    @Test
    public void testProcessLM5()
    {
        String line="%LMY*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processMOLPLM(line, "LM");
        Assert.assertEquals("Y", check.get("LM"));            
    }
    @Test
    public void testProcessLM6()
    {
        String line="%LMXY*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processMOLPLM(line, "LM");
        Assert.assertEquals("XY", check.get("LM"));            
    }
    @Test
    ...
    public void testProcessLR3()
    {
        String line="%LR90.0*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processLRLS(line, "LR");
        Assert.assertEquals("90.0", check.get("LR"));            
    }
    @Test
    public void testProcessLR4()
    {
        String line="%LR-90*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processLRLS(line, "LR");
        Assert.assertEquals("-90", check.get("LR"));            
    }
    @Test
    public void testProcessLR5()
    {
        String line="%LR0.0*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processLRLS(line, "LR");
        Assert.assertEquals("0.0", check.get("LR"));            
    }
    ...
    public void testProcessLS3()
    {
        String line="%LS1.5*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processLRLS(line, "LS");
        Assert.assertEquals("1.5", check.get("LS"));            
    }
    @Test
    public void testProcessLS4()
    {
        String line="%LS0.8*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processLRLS(line, "LS");
        Assert.assertEquals("0.8", check.get("LS"));            
    }
    @Test
    public void testProcessLS5()
    {
        String line="%LS-90*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processLRLS(line, "LS");
        Assert.assertEquals("-90", check.get("LS"));            
    }
    ...
    public void testProcessLS6()
    {
        String line="%LS90*%";
        HashMap<String,String> check=GerberFileProcessingUtil.processLRLS(line, "LR");
        Assert.assertEquals(null, check.get("LR"));            
