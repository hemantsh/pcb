...
public class FileDetails implements Serializable {
    ...
    /**
     *
     * @return the selected value of the file
     */
    ...
    /**
     * Sets the file is selected or not into the selected instance variable
     *
     * @param selected the file selected value to set
     */
